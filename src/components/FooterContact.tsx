        ...
        <div className="container">
              ...
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <div>
                  <span className="font-display text-base font-extrabold text-primary">
                    Infoxeme Construction Intelligence
                  </span>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-start gap-2 text-sm text-muted-foreground">
                  <MapPin size={14} />
                  <div>
                    <div>Infoxeme Technologies LLC</div>
                    <div>13308 Glen Taylor Ln.</div>
                    <div>Herndon, VA 20171</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  <Phone size={14} /> +1 (813) 508-1312
                </div>
              </div>
            </div>
          </div>
          <div className="mt-10 border-t border-border pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
            <p className="text-xs text-muted-foreground">
              © {new Date().getFullYear()} Infoxeme. All rights reserved.
            </p>
            <p className="text-xs text-muted-foreground">
